...
@RestController
@Validated
@RequestMapping("/api/v1/document-reversals/web")
@Tag(
        name = "Document Reversals (Web)",
...
public class DocumentReversalControllerWeb {

    private final DocumentReversalService reversalService;

    public DocumentReversalControllerWeb(DocumentReversalService reversalService) {
