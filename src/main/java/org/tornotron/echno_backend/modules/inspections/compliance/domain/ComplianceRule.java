package org.tornotron.echno_backend.modules.inspections.compliance.domain;
 ...
 */
@GlobalReferenceData("The statutory rule catalogue is curated centrally and read by every organization; rules are keyed by jurisdiction, never by tenant")
@Entity
