...
public interface ComplianceGenerationJobRepository extends JpaRepository<ComplianceGenerationJob, UUID> {
    ...
    @Query("SELECT j FROM ComplianceGenerationJob j "
            ...
            + "AND j.status IN (org.tornotron.echno_backend.modules.inspections.compliance.job.ComplianceJobStatus.QUEUED, "
            + "org.tornotron.echno_backend.modules.inspections.compliance.job.ComplianceJobStatus.RUNNING)")
