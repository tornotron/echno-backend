...
/**
 * The mobile surface of the Toolbox Talks module: where the supervisor drafts the talk on the
 * phone before the shift, takes the attendance and records it. Its twin
 * {@link ToolboxTalksControllerWeb} under {@code /web} exposes the same operations under the
 * same guards for the office.
 */
@RestController
@RequestMapping("/api/v1/toolbox-talks")
@RequireSubscription(feature = ToolboxTalksModule.FEATURE_KEY)
@RequiredArgsConstructor
@Tag(name = "Toolbox Talks", description = "Mobile surface of the Toolbox Talks module: reads for members, writes for the roles that run site safety.")
