...
@Schema(description = "Payload to create a receipt. The receipt number is generated by the server.")
@Data
public class ReceiptCreationDto {
    ...
    @Schema(description = "Lifecycle status of the receipt.", example = "draft")
