...
/**
 * Where a subcontract stands in its life.
 *
...
public enum SubContractStatus {
    ...
    SubContractStatus(String value) {
        this.value = value;
    }
    ...
    public static List<String> wireValues() {
        return Arrays.stream(values()).map(SubContractStatus::value).toList();
    }
    ...
    public static String requireValid(String field, String raw) {
        ...
        for (SubContractStatus candidate : values()) {
